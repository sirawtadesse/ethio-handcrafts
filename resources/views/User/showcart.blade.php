  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
            <div class="mr-4">
            <a  class="navbar-brand" href="index.html"><h2 style="color:black;">Ethio <em>Handcrafts</em></h2></a>
...
@endif
   ...
   <div style="padding: 100px;" align="center" >
    <table style="margin-top:150px; margin-right:100px;">
        <tr style="background-color:green; color:white;">
            <td style="padding: 10px; font-size:20px;">Product Name</td>
            <td style="padding: 10px; font-size:20px;">Quatity</td>
